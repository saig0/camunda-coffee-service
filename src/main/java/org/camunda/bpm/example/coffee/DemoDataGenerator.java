...
public class DemoDataGenerator {
    ...
    public void createUsers(ProcessEngine engine) {
      ...
      coffeeMakerReadProcessDefinition.addPermission(Permissions.READ);
      coffeeMakerReadProcessDefinition.addPermission(Permissions.READ_HISTORY);
      ...
      Filter candidateGroupTasksFilter = filterService.newTaskFilter().setName("CoffeeMaker").setProperties(filterProperties).setOwner("admin").setQuery(query);
